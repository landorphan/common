namespace Landorphan.Common.Threading.Interfaces
{
    ...
    public interface INonRecursiveLock : IQueryDisposable, IQueryAllowsRecursion
    {
        ...
        /// </returns>
        bool IsValidTimeout(TimeSpan timeSpan);
        ...
        /// This instance has already been disposed.
        /// </exception>
        IDisposable TryEnterReadLock(TimeSpan timeout, out bool obtainedLock);
        ...
        /// This instance has already been disposed.
        /// </exception>
        IDisposable TryEnterUpgradeableReadLock(TimeSpan timeout, out bool obtainedLock);
        ...
        /// This instance has already been disposed.
        /// </exception>
        IDisposable TryEnterWriteLock(TimeSpan timeout, out bool obtainedLock);
    }
}
