namespace Landorphan.Common.Threading
{
        ...
        : IComparable<DateTime>, IComparable<InterlockedDateTime>, IComparable, IEquatable<DateTime>, IEquatable<InterlockedDateTime>
    {
        ...
        /// The ticks.
        /// </param>
        public InterlockedDateTime(long ticks)
        {
            _value = ticks;
        }
        ...
        /// </returns>
        public static bool operator ==(DateTime left, InterlockedDateTime right)
        {
        ...
        /// <c> true </c> when the instances are equal, otherwise <c> false </c> .
        /// </returns>
        public static bool operator ==(InterlockedDateTime left, DateTime right)
        {
        ...
        /// <c> true </c> when the instances are equal, otherwise <c> false </c> .
        /// </returns>
        public static bool operator ==(InterlockedDateTime left, InterlockedDateTime right)
        {
            return left.Equals(right);
        }
        ...
        int IComparable.CompareTo(object obj)
        {
            ...
            throw new ArgumentException(StringResources.ObjectMustBeOfTypeDateTimeOrInterlockedDateTime, nameof(obj));
        }
    }
}
