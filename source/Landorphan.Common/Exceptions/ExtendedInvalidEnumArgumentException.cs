namespace Landorphan.Common.Exceptions
{
    ...
    public sealed class ExtendedInvalidEnumArgumentException : LandorphanArgumentException
    {
        ...
        /// </param>
        public ExtendedInvalidEnumArgumentException(string paramName, long invalidValue, Type enumType)
        ...
        /// The enumeration type, or <see cref="Object" /> type if not supplied.
        /// </param>
        public ExtendedInvalidEnumArgumentException(long invalidValue, Type enumType) : this(null, invalidValue, enumType, null, null)
        {
        }
        ...
        private static string NullToDefaultMessage(string paramName, long invalidValue, Type enumType, string message)
        {
