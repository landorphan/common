namespace Landorphan.Common.Exceptions
{
    ...
    public sealed class EventHandlerMustNotHaveNullMethodArgumentException : LandorphanArgumentException
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EventHandlerMustNotHaveNullMethodArgumentException"/> class with a specified error message and the exception that is the
